...
public class DynamicModel implements DynamicModelImpl {
     ...
     */
    @Override
    public void getDynamicItemByPhone(User user, final FoodModelImpl.BaseListener listener) {
        BmobQuery<DynamicItem> query = new BmobQuery<DynamicItem>();
     ...
     * @param dynamicitem
     */
    public void sendDynamicItem(final DynamicItem dynamicitem, final FoodModelImpl.BaseListener listener) {
